...
namespace Tormor.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewData["__tbMessage"] = "Create a New Account";
        ...
        {
            ViewData["__tbMessage"] = "Change Password";
            ViewData["PasswordLength"] = MembershipService.MinPasswordLength;
            return View();
        }
        ...
        [Authorize]
        public ActionResult UsersProfiles()
        {
            if (HttpContext.User != null)
            {
                MembershipUser user = Membership.GetUser(false);
                return RedirectToAction("UsersProfiles", "UserAdministration", new { area = "UserAdministration", id = user.ProviderUserKey });
            }
            return RedirectToAction("Index", "Home");
        }
    }
