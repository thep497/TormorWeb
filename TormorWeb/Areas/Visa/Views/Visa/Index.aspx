<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<Tormor.DomainModel.VisaDetail>>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
<% ViewData["PageTitle"] = Html.ShowTitle("รายละเอียดการขออยู่ต่อ (ต่อ Visa)", ViewData["dtpstartdate"], ViewData["dtpenddate"], Globals.DateFormat); %>
<%: ViewData["PageTitle"] %>
</asp:Content>
    ...
    <% Html.Telerik().Grid(Model)
                     ...
                     .Columns(columns =>
                     {
                         ...
                         columns.Bound(c => c.Alien.Name.FullName)
                             ...
                             //{ 
                             //    % >
                             //    < %: Html.ActionLink(string.IsNullOrWhiteSpace(c.Alien.Name.FullName) ? "-" : c.Alien.Name.FullName,
                             //        "Edit", "Alien",new { area="AlienArea",id = c.Id },null)% >
                             //    < %
                             //})
                             ;
                         columns.Bound(c => c.Alien.Nationality).Width(80);
                         columns.Bound(c => c.StayPeriod).Width(80)
                             .HtmlAttributes(new { @style = "text-align:center" });
                         columns.Bound(c => c.StayReason).Width(80)
                             .HtmlAttributes(new { @style = "text-align:center" });
